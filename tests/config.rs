...
"#
    ...
    with_env_vars(
        &[
            ...
            ("RUSTACCIO_RATE_LIMIT_REQUESTS_PER_WINDOW", None),
            ("RUSTACCIO_RATE_LIMIT_WINDOW_SECS", None),
            ("RUSTACCIO_RATE_LIMIT_REDIS_URL", None),
            ("RUSTACCIO_RATE_LIMIT_FAIL_OPEN", None),
            ("RUSTACCIO_QUOTA_BACKEND", None),
            ("RUSTACCIO_QUOTA_REQUESTS_PER_DAY", None),
            ("RUSTACCIO_QUOTA_DOWNLOADS_PER_DAY", None),
            ("RUSTACCIO_QUOTA_PUBLISHES_PER_DAY", None),
            ("RUSTACCIO_QUOTA_POSTGRES_URL", None),
            ("RUSTACCIO_QUOTA_FAIL_OPEN", None),
            ("RUSTACCIO_METRICS_BACKEND", None),
            ("RUSTACCIO_METRICS_PATH", None),
            ("RUSTACCIO_METRICS_REQUIRE_ADMIN", None),
            ("RUSTACCIO_OTEL_ENABLED", None),
            ("RUSTACCIO_OTEL_EXPORTER_OTLP_ENDPOINT", None),
            ("RUSTACCIO_OTEL_SERVICE_NAME", None),
            ("RUSTACCIO_MANAGED_MODE", None),
            ("RUSTACCIO_ADMIN_ALLOW_ANY_AUTHENTICATED", None),
            ("RUSTACCIO_ADMIN_USERS", None),
            ("RUSTACCIO_ADMIN_GROUPS", None),
            ("RUSTACCIO_STATE_COORDINATION_BACKEND", None),
            ("RUSTACCIO_STATE_COORDINATION_REDIS_URL", None),
            ("RUSTACCIO_STATE_COORDINATION_LOCK_KEY", None),
            ("RUSTACCIO_STATE_COORDINATION_LEASE_MS", None),
            ("RUSTACCIO_STATE_COORDINATION_ACQUIRE_TIMEOUT_MS", None),
            ("RUSTACCIO_STATE_COORDINATION_POLL_INTERVAL_MS", None),
            ("RUSTACCIO_STATE_COORDINATION_FAIL_OPEN", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_BUCKET", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_REGION", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_ENDPOINT", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_ACCESS_KEY_ID", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_SECRET_ACCESS_KEY", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_PREFIX", None),
            ("RUSTACCIO_STATE_COORDINATION_S3_FORCE_PATH_STYLE", None),
            ("RUSTACCIO_PACKAGE_METADATA_AUTHORITY", None),
