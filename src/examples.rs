...
fn env_defaults() -> BTreeMap<&'static str, &'static str> {
    BTreeMap::from([
        ...
        ("RUSTACCIO_STATE_COORDINATION_S3_REGION", "us-east-1"),
        ...
        ("RUSTACCIO_STATE_COORDINATION_S3_FORCE_PATH_STYLE", "false"),
