...
fn env_defaults() -> BTreeMap<&'static str, &'static str> {
    BTreeMap::from([
        ...
        ("RUSTACCIO_CONTROL_PLANE_TOKEN", ""),
        ("RUSTACCIO_CONTROL_PLANE_URL", ""),
        ...
        ("RUSTACCIO_MANAGED_DECISION_CACHE_MAX_ENTRIES", "10000"),
        ("RUSTACCIO_MANAGED_DECISION_CACHE_TTL_MS", "30000"),
        ("RUSTACCIO_MANAGED_DOWNLOAD_MODE", "redirect"),
        ("RUSTACCIO_MANAGED_EVENT_QUEUE_CAPACITY", "1024"),
        ("RUSTACCIO_MANAGED_MAX_METADATA_BYTES", "8388608"),
        ("RUSTACCIO_MANAGED_METADATA_CACHE_MAX_BYTES", "4194304"),
        ("RUSTACCIO_MANAGED_METADATA_CACHE_MAX_ENTRIES", "128"),
        ("RUSTACCIO_MANAGED_METADATA_CACHE_TTL_MS", "0"),
        ("RUSTACCIO_MANAGED_METADATA_ORIGIN", ""),
        ("RUSTACCIO_MANAGED_MODE", "false"),
        ("RUSTACCIO_MANAGED_UPLOAD_TIMEOUT_MS", "300000"),
        ("RUSTACCIO_PACKAGE_CACHE_MAX_ENTRIES", "5000"),
        ("RUSTACCIO_PACKAGE_CACHE_PRUNE_INTERVAL_SECS", "30"),
        ("RUSTACCIO_PACKAGE_CACHE_TTL_SECS", ""),
        ...
        ("RUSTACCIO_POLICY_HTTP_CACHE_MAX_ENTRIES", "10000"),
        ("RUSTACCIO_POLICY_HTTP_CACHE_PRUNE_INTERVAL_MS", "30000"),
        ...
        ("RUSTACCIO_QUOTA_MEMORY_MAX_KEYS", "50000"),
        ("RUSTACCIO_QUOTA_MEMORY_RETENTION_DAYS", "2"),
        ...
        ("RUSTACCIO_RATE_LIMIT_MEMORY_MAX_KEYS", "10000"),
        ...
        ("RUSTACCIO_REQUIRE_PLACEMENT", "false"),
        ...
        ("RUSTACCIO_STATE_COORDINATION_LEASE_MS", "5000"),
        (
